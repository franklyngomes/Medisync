...
// import { OutPatientListQuery, CreateOutPatientQuery, OutPatientUpdateQuery, OutPatientDetailsQuery, OutPatientDeleteQuery } from "../../../api/query/OutPatientQuery"
...
//   const { mutateAsync } = CreateOutPatientQuery()
//   const { editId, isEditing, setIsEditing } = useStore();
//   const { data: details } = OutPatientDetailsQuery(editId, !!editId)
//   const inPatientDetails = details ? details.data : null
//   console.log(inPatientDetails)
//   const { mutateAsync: update } = OutPatientUpdateQuery()
//   const { mutateAsync: deleteInPatient } = OutPatientDeleteQuery()
...
//           <PageBreadcrumb pageTitle="Outpatient List" breadCrumbTitle="Outpatient" />
...
//               {!isEditing ? "Add new outpatient" : "Edit outpatient"}
//             </h4>
//           </div>
